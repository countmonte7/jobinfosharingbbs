...
public class BbsSqls {
	public static final String SELECT_PAGING = "SELECT id, userId, title, content, regdate FROM bbs ORDER BY id DESC LIMIT :start, :limit";
	...
	public static final String SELECT_BY_BBSID = "SELECT id, userId, title, content, regdate FROM bbs WHERE id = :id";
